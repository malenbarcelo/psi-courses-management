    ...
    dataToPrint.forEach((element,index) => {
        ...
        if (eg.idUserCategories != 4) {
            ...
            html += `
                ...
                <th class="${rowClass}"><i class="fa-solid fa-user allowedIcon" id="students_${element.id}"></i></th>
            `
        }else{
            ...
            const studentsIcon = (element.companyReservations != 0 && element.hoursToStart >= 24) ? '<i class="fa-solid fa-user allowedIcon" id="students_' + element.id + '"></i>': '<i class="fa-solid fa-user notAllowedIcon"></i>'
